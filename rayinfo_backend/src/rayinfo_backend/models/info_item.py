...
class RawInfoItem(Base):
    ...
    collected_at = Column(DateTime, default=datetime.utcnow, index=True, comment="采集时间")
    
    # 处理状态
    processed = Column(Integer, default=0, index=True, comment="处理状态：0=未处理，1=已处理，-1=失败")
