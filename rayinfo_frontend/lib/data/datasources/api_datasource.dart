...
class ApiDataSourceImpl implements ApiDataSource {
  ...
  Future<PaginatedArticlesResponse> getArticles({
    ...
    if (readStatus != null) queryParameters['read_status'] = readStatus.toApiParam(); // 添加已读状态参数
  ...
  Future<BatchReadStatusResponse> batchToggleReadStatus(
    ...
    return BatchReadStatusResponse.fromJson(response.data as Map<String, dynamic>);
  }
